...
// Used like any other action creator:
...
export function fetchPosts(subreddit) {
    ...
    return function (dispatch) {
        // First dispatch: The app is updated to inform that the API call is starting.
        ...
        // This is not required by thunk middlweware, but it is convenient for us.
        ...
        return fetch(`https://www.reddit.com/r/${subreddit}.json`)
            ...
            .then(json =>
                ...
                // Here, we update the app state with the resutls of the API call.
